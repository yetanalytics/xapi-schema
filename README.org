...
[[http://clojars.org/com.yetanalytics/xapi-schema][http://clojars.org/com.yetanalytics/xapi-schema/latest-version.svg]]
...
See the file [[file:COPYING][COPYING]] for details.
