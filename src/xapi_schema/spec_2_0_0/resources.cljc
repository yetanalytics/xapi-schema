(ns xapi-schema.spec-2-0-0.resources
  (:require
   [xapi-schema.spec-2-0-0 :as xs :include-macros true]
   [xapi-schema.spec-2-0-0.util :as util :include-macros true]
   [clojure.spec.alpha :as s #?@(:cljs [:include-macros true])]
   [clojure.spec.gen.alpha :as sgen :include-macros true]
   [clojure.walk :as walk]
   #?@(:clj [[clojure.data.json :as json]]))
  #?(:cljs (:require-macros [xapi-schema.spec-2-0-0.resources :refer [json]])))
