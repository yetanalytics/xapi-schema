...
(s/def :xapi.common.param/agent
  (s/with-gen (s/and json-string-conformer
                     ::actor)
    #(sgen/fmap unparse-json (s/gen ::actor))))
...
(s/def :xapi.about.GET.response.body/version
  (s/coll-of ::version :kind vector? :into []))
