...
(def AbsoluteIRIRegEx
  #?(:clj #"(?U)^((([A-Za-z\+\-\.]+:(?:\/{1,2})?)(?:[\w\.\-\~;\*\(\)!\':&=\+\$,%]+@)?[\w\.\-\~\[\]\:\+%]+)((?:\/[\w\.\-\~\+%\/]*)?\??(?:[\w\.\-\~\+=&;%@\*]*)#?(?:[\w\.\~\-\:\$\&\'\(\)+,;\!%\*\/\\\?=]*))?)$"
     :cljs #"(?U)^((([A-Za-z\+\-\.]+:(?:\/{1,2})?)(?:[\w\.\-\~;\*\(\)!\':&=\+\$,%]+@)?[\w\.\-\~\[\]\:\+%]+)((?:/[\w\.\-\~\+%\/]*)?\??(?:[\w\.\-\~\+=&;%@\*]*)#?(?:[\w\.\~\-\:\$\&\'\(\)+,;\!%\*\/\\\?=]*))?)$"))
...
(def AbsoluteURIRegEx
  #?(:clj #"^((([A-Za-z\+\-\.]+:(?:\/{1,2})?)(?:[\w\.\-\~;\*\(\)!\':&=\+\$,%]+@)?[\w\.\-\~\[\]\:\+%]+)((?:\/[\w\.\-\~\+%\/]*)?\??(?:[\w\.\-\~\+=&;%@\*]*)#?(?:[\w\.\~\-\:\$\&\'\(\)+,;\!%\*\/\\\?=]*))?)$"
     :cljs #"^((([A-Za-z\+\-\.]+:(?:\/{1,2})?)(?:[\w\.\-\~;\*\(\)!\':&=\+\$,%]+@)?[\w\.\-\~\[\]\:\+%]+)((?:/[\w\.\-\~\+%\/]*)?\??(?:[\w\.\-\~\+=&;%@\*]*)#?(?:[\w\.\~\-\:\$\&\'\(\)+,;\!%\*\/\\\?=]*))?)$"))
...
(def MailToIRIRegEx
  #"mailto:(?:[\w!#$&'*+/=?^`{|}~-]|%[0-9a-fA-F]{2})+(?:\.(?:[\w!#$&'*+/=?^`{|}~-]|%[0-9a-fA-F]{2})+)*@(?:[a-zA-Z0-9](?:[a-zA-Z0-9-]*[a-zA-Z0-9])?\.)+[a-zA-Z0-9](?:[a-zA-Z0-9-]*[a-zA-Z0-9])?")

(def UuidRegEx
  #"[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[4|1][0-9A-Fa-f]{3}-[89ABab][0-9A-Fa-f]{3}-[0-9A-Fa-f]{12}")

(def TimestampRegEx
  #"^(\d{4}(?!\d{2}\b))((-)((0[1-9]|1[0-2])(\3([12]\d|0[1-9]|3[01]))))((T(0[0-9]|1[0-9]|2[0-3])(:([0-4][0-9]|5[0-9])){2}(\.\d+)?)|T23:59:60)(Z|(?!-00:00)([+-](0[0-9]|1[0-9]|2[0-3])(:([0-4][0-9]|5[0-9]))))$")
